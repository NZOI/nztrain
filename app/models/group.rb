class Group < ActiveRecord::Base
  ...
  has_many :problem_set_associations, -> { includes(:problem_set).order("COALESCE(group_problem_sets.name,problem_sets.name)") }, class_name: GroupProblemSet, dependent: :destroy, inverse_of: :group
