authorization do
  ...
  role :admin do
    ...
    #end
    #has_permission_on [:problems], :to => :manage
    #has_permission_on [:problem_sets], :to => :manage
    #has_permission_on [:contests], :to => :manage
    #has_permission_on [:test_cases], :to => :manage
    #has_permission_on [:test_sets], :to => :manage
    #has_permission_on [:evaluators], :to => :manage
    #has_permission_on [:submissions], :to => :manage
    #has_permission_on [:file_attachments], :to => :manage
  ...
  role :staff do
    ...
    #has_permission_on :problems, :to => :inspect
    #has_permission_on :problem_sets, :to => :inspect
    #has_permission_on :contests, :to => :inspect
    #has_permission_on :test_cases, :to => :inspect
    #has_permission_on :test_sets, :to => :inspect
    #has_permission_on :evaluators, :to => :inspect
    ...
    #end
    #has_permission_on [:submissions], :to => :inspect
