...
CREATE TABLE public.contest_relations (
    ...
    time_taken double precision DEFAULT 0 NOT NULL,
    school_id integer,
...
--
-- Name: group_file_attachments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.filelinks
    ADD CONSTRAINT group_file_attachments_pkey PRIMARY KEY (id);
