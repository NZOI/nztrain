...
ActiveRecord::Schema.define(version: 20250318053450) do
  ...
  create_table "contest_relations", id: :serial, force: :cascade do |t|
    t.integer "user_id"
    ...
    t.index ["contest_id", "score", "time_taken"], name: "index_contest_relations_on_contest_id_and_score_and_time_taken", order: { score: :desc }
    t.index ["contest_id", "user_id"], name: "index_contest_relations_on_contest_id_and_user_id", unique: true
    t.index ["user_id", "started_at"], name: "index_contest_relations_on_user_id_and_started_at"
  end

  create_table "contest_scores", id: :serial, force: :cascade do |t|
    ...
    t.datetime "updated_at"
    t.index ["contest_relation_id", "problem_id"], name: "index_contest_scores_on_contest_relation_id_and_problem_id"
  end

  create_table "contest_supervisors", id: :serial, force: :cascade do |t|
    t.integer "contest_id"
    t.integer "user_id"
  ...
  create_table "filelinks", id: :serial, force: :cascade do |t|
    t.integer "root_id"
    ...
    t.index ["file_attachment_id"], name: "index_filelinks_on_file_attachment_id"
    t.index ["root_id", "filepath"], name: "index_filelinks_on_root_id_and_filepath"
  end

  create_table "group_contests", force: :cascade do |t|
    t.integer "group_id"
    t.integer "contest_id"
    t.index ["contest_id", "group_id"], name: "index_group_contests_on_contest_id_and_group_id"
    t.index ["group_id", "contest_id"], name: "index_group_contests_on_group_id_and_contest_id"
  end
  ...
  create_table "group_problem_sets", force: :cascade do |t|
    ...
    t.integer "problem_set_id"
    t.string "name", limit: 255
    t.index ["group_id", "problem_set_id"], name: "index_group_problem_sets_on_group_id_and_problem_set_id"
    t.index ["problem_set_id", "group_id"], name: "index_group_problem_sets_on_problem_set_id_and_group_id"
  end
  ...
  create_table "item_histories", id: :serial, force: :cascade do |t|
    t.integer "item_id"
    t.boolean "active"
    t.integer "action"
    t.integer "holder_id"
  ...
  create_table "language_groups", id: :serial, force: :cascade do |t|
    t.string "identifier", limit: 255
    t.string "name", limit: 255
    t.integer "current_language_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["identifier"], name: "index_language_groups_on_identifier", unique: true
  end
  ...
  create_table "languages", id: :serial, force: :cascade do |t|
    ...
    t.index ["identifier"], name: "index_languages_on_identifier", unique: true
  end

  create_table "organisations", id: :serial, force: :cascade do |t|
  end

  create_table "problem_series", id: :serial, force: :cascade do |t|
    t.string "name", limit: 255
    t.string "identifier", limit: 255
  ...
  create_table "problem_set_problems", force: :cascade do |t|
    ...
    t.index ["problem_id", "problem_set_id"], name: "index_problem_set_problems_on_problem_id_and_problem_set_id"
    t.index ["problem_set_id", "problem_id"], name: "index_problem_set_problems_on_problem_set_id_and_problem_id"
  end

  create_table "problem_sets", id: :serial, force: :cascade do |t|
    t.string "name", limit: 255
    t.integer "owner_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "submissions", id: :serial, force: :cascade do |t|
    ...
    t.index ["problem_id", "created_at"], name: "index_submissions_on_problem_id_and_created_at"
    t.index ["user_id", "problem_id"], name: "index_submissions_on_user_id_and_problem_id"
  end

  create_table "test_case_relations", id: :serial, force: :cascade do |t|
    t.integer "test_case_id"
    t.integer "test_set_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["test_case_id"], name: "index_test_case_relations_on_test_case_id"
    t.index ["test_set_id"], name: "index_test_case_relations_on_test_set_id"
  end
  ...
  create_table "test_cases", id: :serial, force: :cascade do |t|
    ...
    t.index ["problem_id", "name"], name: "index_test_cases_on_problem_id_and_name", unique: true
  end
  ...
  create_table "test_sets", id: :serial, force: :cascade do |t|
    ...
    t.integer "problem_order"
    t.index ["problem_id", "name"], name: "index_test_sets_on_problem_id_and_name", unique: true
  end

  create_table "user_problem_relations", id: :serial, force: :cascade do |t|
    t.integer "problem_id"
    t.integer "user_id"
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["problem_id", "ranked_score"], name: "index_user_problem_relations_on_problem_id_and_ranked_score"
